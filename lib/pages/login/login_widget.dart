...
import '/components/message_dialog_error_widget.dart';
import '/components/message_dialog_widget.dart';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFFE7E5E5), Color(0xFFFA6527)],
                    stops: [0.0, 1.0],
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'tsm7rsxx' /* Let's get started by filling o... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
