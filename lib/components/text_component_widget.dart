                        ...
                        Builder(
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              ...
                              unawaited(
                                () async {
                                  await actions.escribirYLeerNdef(
                                    FFAppState().tagWrite,
                                  );
                                }(),
                              );
                              if (FFAppState().recordContenidoNFC != null &&
                                ...
                                await showDialog(
                                  ...
                                  builder: (dialogContext) {
                                    return Dialog(
                                      ...
                                      child: MessageDialogTagWidget(
                                        titleDialog:
                                            FFLocalizations.of(context).getText(
                                          'irc443s5' /* Approximate a Tag. */,
                                        ),
                                        bodyDialog:
                                            FFLocalizations.of(context).getText(
                                          '5ob8ybgu' /* Approximate a Tag to record da... */,
                                        ),
                                        title:
                                            FFLocalizations.of(context).getText(
                                          'si2uvixq' /* Information. */,
                                        ),
                                        body:
                                            FFLocalizations.of(context).getText(
                                          'v5s07e7d' /* The data was recorded correctl... */,
                                        ),
                                      ),
                                    );
                                  },
