...
class _BleServerWidgetState extends State<BleServerWidget> {
  ...
  void initState() {
    super.initState();
    _verificarBluetooth();
    _bluetoothTimer = Timer.periodic(
        const Duration(seconds: 3), (_) => _verificarBluetooth());
  }
  ...
  Future<void> _iniciarServidor() async {
    try {
      ...
      _cambioTimer = Timer.periodic(
          const Duration(milliseconds: 300), (_) => _verificarCambio());
    } catch (e) {
